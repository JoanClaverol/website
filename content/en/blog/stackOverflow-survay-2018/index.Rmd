...
The goal of this report is to analyse the stack overflow survey made in 2018, here is the [link](https://www.kaggle.com/stackoverflow/stack-overflow-2018-developer-survey) to the data. We will put the focus on developers working as data analysts and data scientists. The main questions to answer would be:
...
First of all, we will define the profile we are interested in:
...
After filtering our data, we have `r nrow(analyst_df)` respondents, in relation to the `r nrow(data)` in the original data. 
